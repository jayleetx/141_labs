...
Find a state in the county dataset, `us`, and work with that.
...
3. Pick a state and use this data to create a plot of that state's first digit distribution by precinct. If no "total vote" equivalent exists, create one from candidate vote totals.
